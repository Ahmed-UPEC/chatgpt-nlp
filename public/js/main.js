...
//const FLASK_API_URL = "https://4537-193-48-143-174.ngrok.io"; // Flask API URL
...
const getQ_A = async (copyBtn) => {
    ...
    try {
        ...
        const response = await (await fetch(FLASK_API_URL_RENDER + "/feedback", requestOptions)).json();
